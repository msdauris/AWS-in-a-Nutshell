...
| 12       | Create VPC Endpoint  | Create a VPC Endpoint<br>Type: Gateway and add to PRIVATE subnet!!<br> Amend local region '''aws s3 ls --region eu-west-1'''<br>RUN '''aws s3 ls'''<br>**TIP** you may require DEMO IAM role|
